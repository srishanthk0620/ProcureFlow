...
export const demoSchemes = [
 { title:'Produce preparation support', text:'Illustrative local support for drying and preparing produce. Ask the centre about available equipment.', documents:'Sample checklist: farmer profile and produce details. This is not an official eligibility requirement.' },
 { title:'Community transport coordination', text:'Illustrative assistance for farmer groups sharing a vehicle to the procurement centre.', documents:'Sample checklist: group contact, member count and planned quantity. Availability must be verified locally.' },
...
export const guideSections = [
 ...
 { title:'Documents to carry', text:'For this demo, keep your booking token and farmer profile ready. Confirm actual document requirements with your centre.' },
 ...
 { title:'Reaching the centre', text:'Check your slot and centre location. Estimates may change; this demo does not use GPS or live maps.' },
 { title:'Quality inspection', text:'Staff check the produce before weighing. In this demo, advance the stage from Live Status.' },
 { title:'Weighing', text:'Review the recorded quantity with staff. The demonstration does not operate weighing equipment.' },
 { title:'Payment and status', text:'Track completion with your token. Real payment processing is outside this demo.' },
]
export const chatQuestions = [
 ...
 { key:'wfChatChange', answer:'Open the booking details, cancel an upcoming booking, then book a new available slot. Checked-in bookings cannot be cancelled in this demo.', route:'/farmer/bookings' },
